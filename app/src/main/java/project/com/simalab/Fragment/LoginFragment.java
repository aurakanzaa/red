...
public class LoginFragment extends Fragment {
    ...
    RequestServices gotService = ServiceGenerator.createService(RequestServices.class);
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<List<User>> callUser = gotService.getLogin();
        ...
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (editTextPassword.getText().toString().isEmpty() || editTextUsername.getText().toString().isEmpty()){
                    ...
                    for (int pos = 0; pos < loginList.size(); pos++) {
                        User itemLogin = loginList.get(pos);
                        if (editTextUsername.getText().toString().equals(itemLogin.getUsername()) && editTextPassword.getText().toString().equals(itemLogin.getPassword())) {
                            Intent i = new Intent(getContext(), MainActivity.class);
                            i.putExtra("level",itemLogin.getLevel());
                            i.putExtra("id_user",itemLogin.getId_user());
                            i.putExtra("nama",itemLogin.getNama());
                            Log.d("LEVEL",itemLogin.getLevel());
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentManager.beginTransaction().replace(R.id.frame,new RegisterFragment()).commit();
